package com.bin.hibernate.one2one.foreign;
...
//		System.out.println(mgr.getClass());// 只是使用getClass是不会报异常,如果使用里面的属性,就会报异常.
		
		// 3. 查询Manager对象的条件应该是dept.mgr_id = mgr.manager_id,
			// 而不应该是manager0_.MGR_ID=department1_.DEPT_ID
		// 4.这里发送了两次查询,是为什么?
